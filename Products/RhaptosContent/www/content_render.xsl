...
<xsl:stylesheet
  ...
  <xsl:template name="ingredients">
	...
	<a href="{publishing/portal/@href}" title="{publishing/portal/title}">
      ...
      <div><p style="color:white;background-color:#DF571E;font-size:1.25em;text-align:center;">We’re retiring our Legacy Authoring Platform on June 30, 2020. <a style="color:white;" href="https://openstax.org/blog/saying-goodbye-cnx">Learn more</a></p><br /></div>
